    ...
    arg_sub({'BMopts','BrainMovieOptions'},[], ...
        { ...
            ...
            arg_subtoggle({'loni','LONIAtlas','plotloni'},{}, ...
                        { 
                        arg({'lonires','Resolution'},'high',{'full','high','mid','low','smooth'},'Resolution for the LONI mesh atlas. Full/High/Mid/Low corresponds to 100/50/10/1% of original mesh resolution.'), ...
