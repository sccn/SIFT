...
g = arg_define([0 Inf], varargin, ...
    ...
    arg_subswitch({'sigtype','SignalType','chantype'},hlp_getSigTypeArglist(defSigType,true),hlp_getSigTypeArglist(defSigType),'Type of signal to analyze.'), ...
...
if g.normalize.arg_selection
    EEG.icaact = pre_normData('data',EEG.CAT.srcdata,g.normalize,'verb',g.verb);
end
