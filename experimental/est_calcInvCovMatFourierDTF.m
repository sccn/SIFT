% V = est_calcInvCovMatFourierDTF(Rinv,DTF,E,foi,fs,N,p, verb)
%
% Obtain the frequency domain transform of the inverse covariance matrix of 
% an M-variate VAR[p] process
% This is needed for calculating the analytic statistics for the DTF [1]
%
% Inputs:
%
...
% References:
%
% [1] Eichler M (2006) On the evaluation of information flow in multivariate systems by the directed 
%     transfer function. Biological cybernetics 94:469-82
%
...
function V = est_calcInvCovMatFourierDTF(Rinv,DTF,E,foi,fs,N,p, verb)
...
for f=freqs
    ...
    %
    % where COS_ab(u,v) is the a,bth element of the fourier
