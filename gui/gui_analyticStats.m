function varargout = gui_analyticStats(varargin)
%
% GUI_ANALYTICSTATS M-file for gui_analyticStats.fig
%      GUI_ANALYTICSTATS, by itself, creates a new GUI_ANALYTICSTATS or raises the existing
%      singleton*.
%
%      H = GUI_ANALYTICSTATS returns the handle to a new GUI_ANALYTICSTATS or the handle to
%      the existing singleton*.
%
%      GUI_ANALYTICSTATS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_ANALYTICSTATS.M with the given input arguments.
%
%      GUI_ANALYTICSTATS('Property','Value',...) creates a new GUI_ANALYTICSTATS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before gui_analyticStats_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to gui_analyticStats_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @gui_analyticStats_OpeningFcn, ...
                   'gui_OutputFcn',  @gui_analyticStats_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before gui_analyticStats is made visible.
function gui_analyticStats_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to gui_analyticStats (see VARARGIN)

set(hObject,'name','Analytic Statistics');
...
if isempty(varargin)
    error('You must pass ALLEEG to gui_analyticStats');
end
...
function varargout = gui_analyticStats_OutputFcn(hObject, eventdata, handles) 
