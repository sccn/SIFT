function varargout = gui_TimeFreqGrid(varargin)
%
% GUI_TIMEFREQGRID M-file for gui_TimeFreqGrid.fig
%      GUI_TIMEFREQGRID, by itself, creates a new GUI_TIMEFREQGRID or raises the existing
%      singleton*.
%
%      H = GUI_TIMEFREQGRID returns the handle to a new GUI_TIMEFREQGRID or the handle to
%      the existing singleton*.
%
%      GUI_TIMEFREQGRID('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_TIMEFREQGRID.M with the given input arguments.
%
%      GUI_TIMEFREQGRID('Property','Value',...) creates a new GUI_TIMEFREQGRID or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before gui_TimeFreqGrid_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to gui_TimeFreqGrid_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help gui_TimeFreqGrid

% Last Modified by GUIDE v2.5 14-Nov-2010 12:30:06

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @gui_TimeFreqGrid_OpeningFcn, ...
                   'gui_OutputFcn',  @gui_TimeFreqGrid_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before gui_TimeFreqGrid is made visible.
function gui_TimeFreqGrid_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to gui_TimeFreqGrid (see VARARGIN)
...
function varargout = gui_TimeFreqGrid_OutputFcn(hObject, eventdata, handles) 
