...
g = arg_define([0 2],varargin, ...
    ...
    arg({'timeRange','MovieTimeRange'},timedef,[],'Time Range for Movie [Min Max] (sec). Specified w.r.t to event time (e.g., [-1 2]). Leave blank for complete epoch.','shape','row','type','denserealsingle','cat','DataProcessing'), ...
