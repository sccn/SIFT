...
g = arg_define([0 1], varargin, ...
        ...
        arg_subtoggle({'normalize','NormalizeData'},[],@pre_normData,'Data normalization. Normalize analytic amplitude trials across time, ensemble, or both','cat','Normalization','suppress',{'verb'}), ...
...
if g.ampband(2)>EEG.srate/2
    error('SIFT:esT_aamp','Upper pass-band cutoff must be less than the Nyquist rate of %0.5g Hz',EEG.srate/2);
end
