...
function [com] = pop_dipplot_sift( EEG, comps, varargin);

com ='';
if nargin < 1
    help pop_dipplot_sift;
    return;
end;
...
if nargin < 2
	...
	result = inputgui( geometry, uilist, 'pophelp(''pop_dipplot_sift'')', 'Plot dipoles - pop_dipplot');
...
if nargin < 3
    com = sprintf('pop_dipplot_sift( %s,%s);', inputname(1), vararg2str({ comps options{:}}));
end;
return;
