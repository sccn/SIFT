%% TEST0566 tests ENGLISH_WORD_LENGTH_MEAN, ENGLISH_WORD_LENGTH_SAMPLE, ENGLISH_WORD_LENGTH_VARIA
%
%  Modified:
%
%    26 August 2006
...
%
  ...
  mean = english_word_length_mean ( 'DUMMY' );
  variance = english_word_length_variance ( 'DUMMY' );
