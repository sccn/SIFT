function [scalpData srcData LFM chaninds centroids_LFM_idx] = sim_simulateSources(varargin)
...
g=arg_define([0 Inf],varargin,...
    arg_norep({'sourceAmps','SourceAmplitudes'},[],[],'Current density. This is a [num_sources x num_points] matrix of current density for each source','shape','matrix'), ...
