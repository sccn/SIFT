function varargout = gui_surrogate(varargin)
%
% GUI_SURROGATE M-file for gui_surrogate.fig
%      GUI_SURROGATE, by itself, creates a new GUI_SURROGATE or raises the existing
%      singleton*.
%
%      H = GUI_SURROGATE returns the handle to a new GUI_SURROGATE or the handle to
%      the existing singleton*.
%
%      GUI_SURROGATE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_SURROGATE.M with the given input arguments.
%
%      GUI_SURROGATE('Property','Value',...) creates a new GUI_SURROGATE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before gui_surrogate_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to gui_surrogate_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help gui_surrogate

% Last Modified by GUIDE v2.5 08-Sep-2011 10:55:32

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @gui_surrogate_OpeningFcn, ...
                   'gui_OutputFcn',  @gui_surrogate_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before gui_surrogate is made visible.
function gui_surrogate_OpeningFcn(hObject, eventdata, handles, varargin)
...
handles.PropertyGridHandle = arg_guipanel( ...
                ...
                'params',{'ALLEEG',handles.ud.ALLEEG, 'configs', handles.ud.ALLEEG.CAT.configs, varargin{:}});
...
function varargout = gui_surrogate_OutputFcn(hObject, eventdata, handles) 
