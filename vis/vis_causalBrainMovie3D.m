        ...
        { ...
            ...
            arg_subtoggle({'cortex','Cortex','plotcortex'},{}, ...
                        ...
                        arg_subswitch({'cortexcolor','Color'},'LONI_Atlas', ...
                            {'LONI_Atlas' { ...
                                arg({'colormapping','Color'},'auto',[],'Color according to LONI Atlas. If ''auto'' then use colortable from LONI database. Can also be one of the following: An [N x 3] colortable defining the color atlas (N = number of atlas labels). A string containing a function to evaluate to return the colortable (e.g. ''jet(112)''). A cell array containing a colormap function name which accepts as input the number of labels (automatically determined) (e.g. {''jet''})','type','expression','cat','Layers'), ...
                                } ...
                             'Constant' { ...
