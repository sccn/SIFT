function varargout = gui_prepData(varargin)
%
% GUI_PREPDATA M-file for gui_prepData.fig
%      GUI_PREPDATA, by itself, creates a new GUI_PREPDATA or raises the existing
%      singleton*.
%
%      H = GUI_PREPDATA returns the handle to a new GUI_PREPDATA or the handle to
%      the existing singleton*.
%
%      GUI_PREPDATA('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_PREPDATA.M with the given input arguments.
%
%      GUI_PREPDATA('Property','Value',...) creates a new GUI_PREPDATA or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before gui_prepData_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to gui_prepData_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help gui_prepData

% Last Modified by GUIDE v2.5 17-Nov-2010 14:55:34

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @gui_prepData_OpeningFcn, ...
                   'gui_OutputFcn',  @gui_prepData_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before gui_prepData is made visible.
function gui_prepData_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to gui_prepData (see VARARGIN)
...
function varargout = gui_prepData_OutputFcn(hObject, eventdata, handles) 
