...
% Revisions:
%   1/25/04 | Tim Mullen | Function now converts logical scalars to 'true' and 'false'
%
...
function str = struct2str( structure )
	...
	for index = 1:length( allfields )
		...
		str = [ str, '''' allfields{index} ''',{' hlp_vararg2str( allcontent ) '},' ];
	end;
