...
%    projection of the vector b onto the weighted one-norm ball or
%    radius tau. That is, it solves
%
%            minimize  ||b-x||_2  st  ||Dx||_1 <= tau.
%               x
%
%    If D is empty or omitted all weights are set to one. The
%    return value ITN given the number of elements of B that were
%    thresholded. 
%
% See also spgl1.
